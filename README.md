...
<!-- authors -->
**Maintainers:** 
Leslie Pérez Cáceres [![ORCID][orcid-icon]](https://orcid.org/0000-0001-5553-6150), 
Yunshuang Xiao [![ORCID][orcid-icon]](https://orcid.org/0009-0003-6752-8627)

**Authors:** Leslie Pérez Cáceres, 
Jonas Kuckling [![ORCID][orcid-icon]](https://orcid.org/0000-0003-2391-2275), 
Pablo Contreras [![ORCID][orcid-icon]](https://orcid.org/0009-0001-8801-9018), 
Yunshuang Xiao, 
Thomas Stützle [![ORCID][orcid-icon]](https://orcid.org/0000-0002-5820-0473).

**Contributors:** Manuel López-Ibáñez [![ORCID][orcid-icon]](https://orcid.org/0000-0001-9974-1295).

**Contact**: [race.autoconfig@gmail.com](mailto:race.autoconfig@gmail.com)
...
Python >= 3.6.0 is required for running crace, but you don't need to 
...
> **Note:** This package is curretly tested with Python versions up to `3.14.3`.
...
install the crace package (see section Installing the crace package).
...
it does not come already bottled so you need to have [Xcode](https://developer.apple.com/xcode/download/) installed to compile it):
...
3.  Modify the generated files following the instructions found within 
    ...
    - The script file `target-runner` should be executable. The output of 
      `target-runner` is minimized by default. If you wish to maximize 
      it, just multiply the value by `-1` within the script.

    - If you are using Windows, or if the script file 'target-runner' is in 
      **.bat**, **.py** or **.Rscript** format, please use option `targetRunnerLauncher`
      instead of `targetRunner` and set `targetRunnerLauncher="cmd file.bat"`.
...
directory of each run of crace will be set to `./exp-xx`, where `xx`
