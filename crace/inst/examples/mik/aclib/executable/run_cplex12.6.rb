...
#=== For this to work, point the line below to the absolute path to your CPLEX binary!
cplex_executable_absolute_filename = "/opt/ohpc/pub/utils/cplex/22.1.1/cplex/bin/x86-64_linux/cplex"

def output_help(out)
	out.puts "This starts an interactive session of CPLEX 12.6, reads the specified instance, sets the specified timelimit and the specified parameters, displayes all parameter settings, and solves the instance using optimize. All output is directed to $stdout."
